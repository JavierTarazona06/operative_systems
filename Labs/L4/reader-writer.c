...
int mainp()
{
  ...
  srand(71);
  Initialize();
  temp = RttCreate(&reader1Pid, (void(*)()) reader,STKSIZE,"R1", 
  (void *) 1000, 
		      attr, RTTUSR );
  if (temp == RTTFAILED) perror("RttCreate");

  temp2 = RttCreate(&writer1Pid, (void(*)()) writer,STKSIZE,"W1", 
  (void *) 500,
		    attr, RTTUSR );
  if (temp2 == RTTFAILED) perror("RttCreate");

  temp3 = RttCreate(&reader2Pid, (void(*)()) reader,STKSIZE,"R2", 
  (void *) 1001,
		       attr, RTTUSR );
  if (temp3 == RTTFAILED) perror("RttCreate");
  temp3 = RttCreate(&reader3Pid, (void(*)()) reader,STKSIZE,"R3", 
  (void *) 1002,
		    attr, RTTUSR );
  if (temp3 == RTTFAILED) perror("RttCreate");
  
  temp3 = RttCreate(&writer2Pid, (void(*)()) writer,STKSIZE,"W2", 
  (void *) 501, 
		    attr, RTTUSR );
  if (temp3 == RTTFAILED) perror("RttCreate");
